...
public class Main {
	 ...
	 * @return RESTForm A new RESTForm instance that is populated with test data.
	 */
	private static buildRESTInfoForm(startDate, endDate, infoFormID) {

		def questionGroups = getQuestionGroups(infoFormID);
		...
		def restInfoForm = new RESTForm(id: infoFormID, numberAsked: 1, startDate: startDate, endDate: endDate,
